COMMENT @
	...
	Thank you tremwil(https://github.com/tremwil) for the suggestion and the help writing the asm wrapper. It's bad because I am bad, not cause tremwil told me to write it this way (just fyi :fatcat:).
@
